...
std::string Pedido::getDescricaoPedido() const
{
...
std::string Pedido::getCPF() const
{
    return CPF;
}

void Pedido::setCodigoPedido(int codigo)
{
    codigoPedido = codigo;
}

void Pedido::setDescricaoPedido(const std::string &descricao)
{
    descricaoPedido = descricao;
}

void Pedido::setTempoEstimado(int tempo)
{
    tempoEstimado = tempo;
}

void Pedido::setCPF(const std::string &cpf)
{
    CPF = cpf;
}